    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <Button asChild variant="outline">
          <Link href="/sbh-1111/applications/export">Export to Excel</Link>
        </Button>
      </div>

      <div className="mb-6 flex flex-wrap gap-2">
        <Link href="/sbh-1111/applications">
        ...
        {FILTER_STATUSES.map((s) => {
          ...
          return (
            <Link key={s} href={`/sbh-1111/applications?status=${s}`}>
              ...
              <TableRow key={app.id}>
                ...
                <TableCell className="text-right">
                  <Button asChild variant="outline" size="sm">
                    <Link href={`/sbh-1111/applications/${app.id}`}>View</Link>
                  </Button>
                </TableCell>
              </TableRow>
            );
