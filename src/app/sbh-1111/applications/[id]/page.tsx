...
export default async function ApplicationDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href="/sbh-1111/applications" className="text-sm text-muted-foreground hover:text-foreground">
            ...
            <div className="border-t pt-5">
              ...
              {app.speaker ? (
                <p className="text-sm text-muted-foreground">
                  ...
                  <Link href={`/sbh-1111/speakers/${app.speaker.id}`} className="text-primary underline underline-offset-2">
                    /sbh-1111/speakers
                  </Link>{" "}
