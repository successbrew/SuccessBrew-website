...
export default async function SpeakerDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href="/sbh-1111/speakers" className="text-sm text-muted-foreground hover:text-foreground">
          ← Back to Speakers
        </Link>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Link href={`/sbh-1111/applications/${speaker.applicationId}`} className="text-sm text-primary underline underline-offset-2">
        ...
        <Card>
          ...
          <CardContent>
            <ContentForm
              ...
              redirectTo={`/sbh-1111/speakers/${speaker.id}`}
            />
          </CardContent>
        </Card>
