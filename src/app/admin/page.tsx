      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader className="flex-row items-center justify-between space-y-0">
            ...
            <Link href="/admin/applications" className="text-xs font-medium text-primary underline underline-offset-2">
              View all
            </Link>
          </CardHeader>
          <CardContent>
                  ...
                  return (
                    <li key={app.id} className="flex items-center justify-between gap-3 py-3 first:pt-0 last:pb-0">
                      <div className="min-w-0">
                        <Link href={`/admin/applications/${app.id}`} className="truncate text-sm font-medium hover:underline">
        ...
        <Card>
          <CardHeader className="flex-row items-center justify-between space-y-0">
            ...
            <Link href="/admin/audit-logs" className="text-xs font-medium text-primary underline underline-offset-2">
              View all
            </Link>
          </CardHeader>
          <CardContent>
